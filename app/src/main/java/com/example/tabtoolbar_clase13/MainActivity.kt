            ...
            TabLayoutMediator.TabConfigurationStrategy({
                ...
                when(position){
                    ...
                    1 ->{
                        ...
                        val badge:BadgeDrawable = tab.orCreateBadge
                        badge.backgroundColor = ContextCompat.getColor(applicationContext,R.color.purple_500)
                        badge.number = 17
                        badge.isVisible
                    }
                    2 ->{
                        ...
                        val badge:BadgeDrawable = tab.orCreateBadge
                        badge.backgroundColor = ContextCompat.getColor(applicationContext,R.color.white)
                        badge.number = 100
